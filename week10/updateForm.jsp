	...
	<h1 class="text-center font-weight-bold">게시글 수정</h1>
		...
		<form action="updatePro.jsp" method="post">
			...
			<div class="text-center">
				...
				<button type="button" class="btn btn-secondary" onclick="location.href='list.jsp'">취소</button>
				<button type="button" class="btn btn-secondary" onclick="location.href='delete.jsp?id=<%=id%>'">삭제</button>
